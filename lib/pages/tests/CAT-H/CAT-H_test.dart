...
class CATHtest extends StatefulWidget {
  const CATHtest({Key? key}) : super(key: key);

  @override
  State<CATHtest> createState() => _CATHtestState();
}

class _CATHtestState extends State<CATHtest> {
  ...
  Future<void> startRecording(String IDEval, String EstimuloName) async {
    ...
    var body = jsonEncode({
      'filename': 'CAT-H_test_$EstimuloName$idEval.mp4',
      'IDEval': IDEval,
