...
class Rorsch_test extends StatefulWidget {
  const Rorsch_test({Key? key}) : super(key: key);

  @override
  State<Rorsch_test> createState() => _RorschtestState();
}

class _RorschtestState extends State<Rorsch_test> {
  ...
  Future<void> startRecording(String IDEval, String EstimuloName) async {
    ...
    var body = jsonEncode({
      'filename': 'Rorsch_test_$EstimuloName$idEval.mp4',
      'IDEval': IDEval,
